...
const App = () => {
  ...
  React.useEffect(() => {
    fetch(
      "https://api.github.com/repos/manoedinata/revanced-magisk-module/releases/latest"
    )
      .then((res) => res.json())
      .then((json) => {
        setResponse(json);
      ...
      <div className="px-2 py-4 w-auto h-100">
        <div className="flex flex-col md:flex-row ">
          <div className="flex flex-col space-y-2 md:pl-3">
            ...
            <p className="text-gray-300 max-w-lg text-xs">If you are having problems with latest version of release, download previous releases from our <a href="https://t.me/revanced_manoedinata">Telegram channel</a> or <a href="https://github.com/manoedinata/revanced-magisk-module/releases">GitHub releases</a>.</p>
          </div>
          ...
          <div className="flex flex-col justify-center items-center mt-6 border border-gray-400 p-4 rounded-3xl bg-gray-900">
            ...
            <p className="pt-2 text-sm">
              ...
              <a
                ...
                href="https://github.com/manoedinata/revanced-magisk-module"
              >
                GitHub
              </a>
            </p>
            <p>Join our <a href="https://t.me/revanced_manoedinata">Telegram</a> for release updates.</p>
          </div>
        </div>
    </div>
  );
